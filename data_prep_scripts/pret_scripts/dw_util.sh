...
#cat $1 | xargs -I '{}' -P $nt yt-dlp -f "bestaudio/best" -ciw -o "$save_dir/%(id)s.%(ext)s" --extract-audio --audio-format wav --#audio-quality 0 --no-playlist https://youtu.be/{} --ppa "ffmpeg:-ac 1 -ar 16000" #--quiet &&
